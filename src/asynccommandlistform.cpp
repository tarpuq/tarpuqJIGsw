...
#include "ui_asynccommandlistform.h"
#include <QMessageBox>

AsyncCommandListForm::AsyncCommandListForm(QWidget *parent)
    : QWidget(parent)
    , ui(new Ui::AsyncCommandListForm)
{
    ui->setupUi(this);
...
AsyncCommandListForm::~AsyncCommandListForm()
{
    delete ui;
}

void AsyncCommandListForm::on_pushButton_opcional1_clicked()
{
    emit opcionalCommandExecuted(commandList->at(0));
}

void AsyncCommandListForm::on_pushButton_opcional2_clicked()
{
    emit opcionalCommandExecuted(commandList->at(1));
}

void AsyncCommandListForm::on_pushButton_opcional3_clicked()
{
    emit opcionalCommandExecuted(commandList->at(2));
}

void AsyncCommandListForm::on_pushButton_opcional4_clicked()
{
    emit opcionalCommandExecuted(commandList->at(3));
}

void AsyncCommandListForm::on_pushButton_opcional5_clicked()
{
    emit opcionalCommandExecuted(commandList->at(4));
}

void AsyncCommandListForm::on_pushButton_opcional6_clicked()
{
    emit opcionalCommandExecuted(commandList->at(5));
}

void AsyncCommandListForm::on_pushButton_opcional7_clicked()
{
    emit opcionalCommandExecuted(commandList->at(6));
}

void AsyncCommandListForm::on_pushButton_opcional8_clicked()
{
    emit opcionalCommandExecuted(commandList->at(8));
}

void AsyncCommandListForm::on_pushButton_opcional9_clicked()
{
    emit opcionalCommandExecuted(commandList->at(9));
}

QList<JigSyncCommand *> *AsyncCommandListForm::getCommandList() const
{
    return commandList;
}

void AsyncCommandListForm::setCommandList(QList<JigSyncCommand *> *value)
{
    commandList = value;
}

void AsyncCommandListForm::refreshButtons()
{
    if (commandList) {
...
void AsyncCommandListForm::on_actionEditOptionalCommand_triggered()
{
