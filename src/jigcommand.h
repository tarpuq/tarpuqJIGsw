...
class JigCommand : public QObject
{
    Q_OBJECT
public:
    explicit JigCommand(QObject *parent = nullptr);
    JigCommand(QObject *parent, const JigCommand &other);
    JigCommand &operator=(const JigCommand &other);
